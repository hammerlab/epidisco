...
type t = {
  ...
  vaxrank_include_mismatches_after_variant: bool;
  ...
  (* NOTIFICATIONS: *)
  email_options: Qc.EDSL.email_options option [@docs "MAILGUN NOTIFICATIONS"];
  [@term Qc.EDSL.email_options_cmdliner_term]
  (** Email options for notifications. *)

  (* OTHER TOOLS *)
  with_kallisto: bool [@docs "OTHER TOOLS"];
  (** Also run with `kallisto`. *)
  with_topiary: bool [@docs "OTHER TOOLS"];
  (** Also run with `topiary`. *)
  with_seq2hla: bool [@docs "OTHER TOOLS"];
  (** Also run with `seq2hla`. *)
  with_mutect2: bool [@docs "OTHER TOOLS"];
  (** Also run with `mutect2`. *)
  with_varscan: bool [@docs "OTHER TOOLS"];
  (** Also run with `varscan`. *)
  with_somaticsniper: bool [@docs "OTHER TOOLS"];
  (** Also run with `somaticsniper`. *)
  with_optitype_normal: bool [@docs "OTHER TOOLS"];
  (** Also run with `optitype-normal`. *)
  with_optitype_tumor: bool [@docs "OTHER TOOLS"];
